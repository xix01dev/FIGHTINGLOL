...
const s = {
  ...
  mainFrame: {
    ...
    // --- แก้ไขตรงนี้ให้ขอบด้านในโค้งมน ---
    borderRadius: "45px", 
    border: "2px solid transparent", // ปรับเฟรมให้บางลงตามที่เคยต้องการ
    backgroundImage: "linear-gradient(#0a0a0a, #0a0a0a), linear-gradient(135deg, #FF2E63, #08D9D6)",
    backgroundOrigin: "border-box",
    backgroundClip: "padding-box, border-box", // เปลี่ยนจาก content-box เป็น padding-box เพื่อให้สีพื้นหลังดำโค้งมนตาม border
    boxShadow: "0 0 25px rgba(255, 46, 99, 0.3), 0 0 25px rgba(8, 217, 214, 0.3)",
    boxSizing: "border-box",
    overflow: "hidden", // ช่วยบังคับให้ content ข้างในไม่หลุดโค้ง
  },
  innerTitleBox: {
    position: "absolute", 
    top: "15px", 
  ...
  muaythaiText: {
    ...
    fontWeight: "900", 
    color: "#fff",
    textShadow: "0 0 5px #FF2E63, 0 0 10px #FF2E63",
  ...
  videoWrapper: {
    ...
    height: "100%",
    backgroundColor: "#000", 
    borderRadius: "30px", // มนรับกับเฟรมหลัก
    overflow: "hidden",
